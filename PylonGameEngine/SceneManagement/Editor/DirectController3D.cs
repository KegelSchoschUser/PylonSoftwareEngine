...
//namespace PylonGameEngine.SceneManagement.Editor
//{
...
//        public GameObject3D AttachedObject { get; private set; }
//        private Pen P;
...
//        public void Attach(GameObject3D Object, bool local = false, ControllerMode mode = ControllerMode.Transform, bool drawname = false)
//        {
...
//                {
//                    Vector3 CameraPosition = MyGameWorld.ActiveCamera.Transform.WorldPosition;
...
//                        Vector2 ScreenP1 = MyGameWorld.ActiveCamera.WorldToScreenPoint2(P1);
//                        Vector2 ScreenP2 = MyGameWorld.ActiveCamera.WorldToScreenPoint2(P2);

//                        if (MyGameWorld.ActiveCamera.PointInView(P1) && MyGameWorld.ActiveCamera.PointInView(P2))
...
//                return;
//            if (MyGameWorld.ActiveCamera.PointInView(AttachedObject.Transform.WorldPosition) == false)
//                return;

//            float Length = Vector3.Distance(AttachedObject.Transform.WorldPosition, MyGameWorld.ActiveCamera.Transform.WorldPosition) / 4f;
//            switch (Mode)
//            {
...
//            if (TransformMode)
//                Length = Length *= 1.3f;
//            Vector2 ScreenCenter = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Transform.WorldPosition);
...
//            Vector2 ScreenX1 = MyGameWorld.ActiveCamera.WorldToScreenPoint2(X1);
//            Vector2 ScreenY1 = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Y1);
//            Vector2 ScreenZ1 = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Z1);
...
//            if (Local)
//            {
//                VertsX = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Primitves3D.CreateHollowCircle(32, Transform.WorldPosition, new Vector3(Radius), Transform.Rotation * Quaternion.FromEuler(0, 0, 90)));
//                VertsY = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Primitves3D.CreateHollowCircle(32, Transform.WorldPosition, new Vector3(Radius), Transform.Rotation * Quaternion.Identity));
//                VertsZ = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Primitves3D.CreateHollowCircle(32, Transform.WorldPosition, new Vector3(Radius), Transform.Rotation * Quaternion.FromEuler(90, 0, 0)));
//            }
//            else
//            {
//                VertsX = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Primitves3D.CreateHollowCircle(32, Transform.WorldPosition, new Vector3(Radius), Quaternion.FromEuler(0, 0, 90)));
//                VertsY = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Primitves3D.CreateHollowCircle(32, Transform.WorldPosition, new Vector3(Radius), Quaternion.Identity));
//                VertsZ = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Primitves3D.CreateHollowCircle(32, Transform.WorldPosition, new Vector3(Radius), Quaternion.FromEuler(90, 0, 0)));
//            }
...
//        {
//            Vector2 TextLocation = MyGameWorld.ActiveCamera.WorldToScreenPoint2(Transform.WorldPosition);
