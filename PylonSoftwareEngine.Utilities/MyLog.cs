...
namespace PylonSoftwareEngine.Utilities
{
    public class MyLog
    {
        ...
        private void Init(string FolderPath, string appName, string appversion)
        {
            ...
            PylonSoftwareEngineASCII += @"||  _____       _              _____                      ______             _              ||" + "\n";
            PylonSoftwareEngineASCII += @"|| |  __ \     | |            / ____|                    |  ____|           (_)             ||" + "\n";
            PylonSoftwareEngineASCII += @"|| | |__) |   _| | ___  _ __ | |  __  __ _ _ __ ___   ___| |__   _ __   __ _ _ _ __   ___   ||" + "\n";
            PylonSoftwareEngineASCII += @"|| |  ___/ | | | |/ _ \| '_ \| | |_ |/ _` | '_ ` _ \ / _ \  __| | '_ \ / _` | | '_ \ / _ \  ||" + "\n";
            PylonSoftwareEngineASCII += @"|| | |   | |_| | | (_) | | | | |__| | (_| | | | | | |  __/ |____| | | | (_| | | | | |  __/  ||" + "\n";
            PylonSoftwareEngineASCII += @"|| |_|    \__, |_|\___/|_| |_|\_____|\__,_|_| |_| |_|\___|______|_| |_|\__, |_|_| |_|\___|  ||" + "\n";
            PylonSoftwareEngineASCII += @"||         __/ |                                                        __/ |               ||" + "\n";
            PylonSoftwareEngineASCII += @"||        |___/                                                        |___/                ||" + "\n";
            PylonSoftwareEngineASCII += @"||==========================================================================================||" + "\n";
