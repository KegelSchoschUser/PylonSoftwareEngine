...
namespace PylonSoftwareEngine.Physics
{
    public class RigidBody : PhysicsComponent
    {
        ...
        public RigidBody(List<PylonSoftwareEngine.Mathematics.Triangle> Triangles, float mass = 1f)
        {
        ...
        /// <param name="mass">Mass</param>
        public RigidBody(PylonSoftwareEngine.Mathematics.Triangle Triangle, float mass = 1f)
        {
            BeforeConstructor(mass);
            InitDesc.Shape = InitializationDescription.Shapes.Mesh;
