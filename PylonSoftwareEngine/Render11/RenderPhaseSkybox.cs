...
//using PylonSoftwareEngine.SoftwareWorld;
...
//        {
//            Compiler.Compile(PylonSoftwareEngine.Resources.Shaders.VertexShader3D, "EntryPoint3D", this.GetType().Name, "vs_4_0", out Blob ShaderByteCode, out Blob ErrorBlob);
//            if (ErrorBlob != null)
//            {
...
//            if (Material == null)
//                return;
//            var CameraPositionBuffer = CreateStructBuffer(new CameraPositionBufferStructure() { CameraPosition = MySoftwareWorld.ActiveCamera.Transform.WorldPosition });
...
//            Mathematics.Matrix4x4 ObjectMatrix = Matrix4x4.Translation(MySoftwareWorld.ActiveCamera.Transform.WorldPosition);
